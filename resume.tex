...
%%Begin%% Body
{
    ...
    \begin{tabularx}{\textwidth}{llX}
     ...
     \faHtml5\space\space\space{\bfseries Front-end}                               & {\small\color{darkgrey} \textbullet\space\space HTML5, CSS3, Sass, ES6/7/8, JavaScript (jQuery), React \& Redux, Webpack 3 \& 4} & \\[12pt]
                                                                                                                  & {\small\color{darkgrey} \textbullet\space\space Bootstrap 3 \& 4, Material UI, Kendo} & \\[12pt]                                                  
